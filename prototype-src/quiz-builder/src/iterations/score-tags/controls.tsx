...
export function FineTuning({ state, onChange }: { state: TagState; onChange: (patch: Partial<TagState>) => void }) {
  return (
    <div style={wrap}>
      <div>
      ...
      <div>
        ...
        <Seg value={state.scenario} onPick={scenario => onChange({ scenario })} options={[
          ...
          { id: 'empty', label: 'Untagged' },
          { id: 'offer', label: 'Offers set' },
